...
<head>
	...
	<link href="media/css/bootstrap-wysijsp5.css" rel="stylesheet" type="text/css" />
...
<body class="page-header-fixed">
	...
	<script src="media/js/wysijsp5-0.3.0.js" type="text/javascript" ></script> 

	<script src="media/js/bootstrap-wysijsp5.js" type="text/javascript" ></script>
