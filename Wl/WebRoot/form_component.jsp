...
<head>
	...
	<link rel="stylesheet" type="text/css" href="media/css/bootstrap-wysijsp5.css" />
...
<body class="page-header-fixed">
							...
							<div class="portlet-body form">
								...
								<form action="#" class="form-horizontal">
									...
									<div class="control-group">
										...
										<label class="control-label">WYSIjsp5 Editor 1</label>

										<div class="controls">

											<textarea class="span12 wysijsp5 m-wrap" rows="6"></textarea>
									...
									<div class="control-group">
										...
										<label class="control-label">WYSIjsp5 Editor 2</label>
	...
	<script type="text/javascript" src="media/js/wysijsp5-0.3.0.js"></script> 

	<script type="text/javascript" src="media/js/bootstrap-wysijsp5.js"></script>
