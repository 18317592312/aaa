									...
									<li>
										...
										<ul class="branch in">
											...
											<li>
												...
												<a href="assets/plugins/bootstrap-tree/jspexample.jsp" data-role="branch" class="tree-toggle closed" data-toggle="branch" data-value="jsp_Example">Load data from jsp page via Ajax
