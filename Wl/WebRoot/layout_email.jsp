					...
					<div class="span12">
						...
						<div class="mail-template">
							...
							<ul class="inline">
								...
								<li class="color-black tooltips" data-original-title="Click to preview the template" ><a href="email1.jsp" target="_blank">&nbsp;</a></li>

								<li class="color-darkblue tooltips" data-original-title="Click to preview the template"><a href="email2.jsp" target="_blank">&nbsp;</a></li>

								<li class="color-lightblue tooltips" data-original-title="Click to preview the template"><a href="email3.jsp" target="_blank">&nbsp;</a></li>

								<li class="color-red tooltips" data-original-title="Click to preview the template"><a href="email4.jsp" target="_blank">&nbsp;</a></li>

								<li class="color-green tooltips" data-original-title="Click to preview the template"><a href="email5.jsp" target="_blank">&nbsp;</a></li>
						...
						<div class="mail-template">
							...
							<ul class="inline">
								...
								<li class="color-black tooltips" data-original-title="Click to preview the template"><a href="email6.jsp" target="_blank">&nbsp;</a></li>
