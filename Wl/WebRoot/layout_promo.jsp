						...
						<ul class="nav">
							...
							<li  class="active">
								...
								<ul class="dropdown-menu">
									...
									<li >
										...
										<a href="layout_boxed_page.jsp">Boxed Page</a>
										...
										<ul class="dropdown-menu">
											...
											<li class="dropdown-submenu">
												...
												<ul class="dropdown-menu">
													...
													<li><a tabindex="-1" href="index.jsp">Third level link</a></li>
											...
											<li><a tabindex="-1" href="index.jsp">Second level link</a></li>
							...
							<li>
								...
								<ul class="dropdown-menu">
									...
									<li><a href="index.jsp">Pricing</a></li>

									<li><a href="index.jsp">FAQs</a></li>

									<li><a href="index.jsp">Gallery</a></li>

									<li><a href="index.jsp">Registration</a></li>

									<li><a href="index.jsp">2 Columns (Left)</a></li>

									<li><a href="index.jsp">2 Columns (Right)</a></li>
							...
							<ul class="sub-menu">
								...
								<li>
									...
									<ul class="sub-menu">
										...
										<li><a href="index.jsp">Third level link</a></li>
								...
								<li><a href="index.jsp">Second level link</a></li>
										...
										<div class="active item">
											...
											<div class="row-fluid">
												...
												<div class="span7 margin-bottom-20 margin-top-20 animated rotateInUpRight">
													...
													<a href="index.jsp" class="btn red big xlarge">
												...
												<div class="span5 animated rotateInDownLeft">
													...
													<a href="index.jsp"><img src="media/image/img1.png" alt=""></a>
										...
										<div class="item">
											...
											<div class="row-fluid">
												...
												<div class="span5 animated rotateInUpRight">
													...
													<a href="index.jsp"><img src="media/image/img1_2.png" alt=""></a>
												...
												<div class="span7 margin-bottom-20 animated rotateInDownLeft">
													...
													<a href="index.jsp" class="btn green big xlarge">
							...
							<div class="container">
								...
								<div class="row-fluid">
									...
									<div class="span5 margin-bottom-20">
										...
										<a href="index.jsp"><img src="media/image/img2.png" alt=""></a>
									...
									<div class="span7">
										...
										<a href="index.jsp" class="btn blue big xlarge">
							...
							<div class="container">
								...
								<div class="row-fluid margin-bottom-20">
									...
									<div class="span6 margin-bottom-20">
										...
										<a href="index.jsp"><img src="media/image/img3.png" alt=""></a>
								...
								<div class="row-fluid">
									...
									<div class="span6">
										...
										<a href="index.jsp"><img src="media/image/img4.png" alt=""></a>
